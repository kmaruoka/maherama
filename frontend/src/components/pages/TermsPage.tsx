      ...
      <Container>
        <Card className="terms-page__card">
          <Card.Body className="terms-page__content">
            ...
            <div className="terms-page__section">
              <h2 className="terms-page__section-title">第1条（適用）</h2>
              <p>本規約は、本サービスの利用に関する一切の関係に適用されます。当事業者は必要に応じて本規約を変更できるものとし、変更後の規約は本サービス上に表示した時点から効力を生じます。</p>
            </div>

            <div className="terms-page__section">
              <h2 className="terms-page__section-title">第2条（利用登録）</h2>
            ...
            <div className="terms-page__section">
              <h2 className="terms-page__section-title">第3条（禁止事項）</h2>
            ...
            <div className="terms-page__section">
              <h2 className="terms-page__section-title">第4条（課金サービス）</h2>
            ...
            <div className="terms-page__section">
              <h2 className="terms-page__section-title">第5条（投稿コンテンツ）</h2>
              <ul>
            ...
            <div className="terms-page__section">
              <h2 className="terms-page__section-title">第6条（位置情報の利用）</h2>
              <ul>
            ...
            <div className="terms-page__section">
              <h2 className="terms-page__section-title">第7条（免責事項）</h2>
              <ul>
            ...
            <div className="terms-page__section">
              <h2 className="terms-page__section-title">第8条（サービスの停止・終了）</h2>
            ...
            <div className="terms-page__section">
              <h2 className="terms-page__section-title">第9条（利用制限）</h2>
              <p>当事業者は、ユーザーが本規約に違反した場合、事前通知なく利用停止や登録抹消を行うことができます。</p>
            </div>

            <div className="terms-page__section">
              <h2 className="terms-page__section-title">第10条（準拠法・管轄）</h2>
              <p>本規約の解釈は日本法に準拠します。本サービスに関して紛争が生じた場合は、当事業者の所在地を管轄する裁判所を第一審の専属的合意管轄とします。</p>
            </div>

            <div className="terms-page__section">
              <p className="terms-page__effective-date">
